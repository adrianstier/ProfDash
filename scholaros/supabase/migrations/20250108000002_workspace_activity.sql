...
CREATE INDEX idx_workspace_activity_task ON workspace_activity(task_id) WHERE task_id IS NOT NULL;
CREATE INDEX idx_workspace_activity_project ON workspace_activity(project_id) WHERE project_id IS NOT NULL;

-- Composite index for feed queries
CREATE INDEX idx_workspace_activity_feed ON workspace_activity(workspace_id, created_at DESC);
